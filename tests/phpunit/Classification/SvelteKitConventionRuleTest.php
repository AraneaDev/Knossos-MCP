...
final class SvelteKitConventionRuleTest extends KnossosTestCase
{
    ...
    public static function paths(): array
    {
        return [
            ...
            'page component' => ['apps/web/src/routes/[lang]/+page.svelte', true],
            'layout component' => ['apps/web/src/routes/+layout.svelte', true],
            'error component' => ['apps/web/src/routes/+error.svelte', true],
            'layout reset' => ['apps/web/src/routes/(app)/+page@.svelte', true],
            'ordinary component' => ['apps/web/src/lib/Button.svelte', false],
