...
final readonly class AgentBriefService extends AbstractArchitectureQueryService
{
     ...
     * scaffolding.
     *
     * The predicate itself lives in {@see EntryPointCriteria}, which the
     * session brief asks the same question of. It used to be written out here
     * and, in a shorter form that matched node kinds only, there — and the two
     * had already drifted far enough that the session brief showed no entry
     * points at all for this repository.
     */
    private function entryPointsSection(string $projectId): ?string
    {
        $statement = $this->pdo->prepare(
            ...
            'WHERE n.project_id = :project AND ' . EntryPointCriteria::sqlCondition() .
