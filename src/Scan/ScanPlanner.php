...
final readonly class ScanPlanner
{
    ...
    public function prepare(
        ...
        $configurationHashes = [
            ...
            'typescript' => $this->configurationHash($discovery->units, ['node', 'typescript', 'tool_config', 'knossos'], 'typescript-analysis-v16'),
            ...
            'python' => $this->configurationHash($discovery->units, ['python', 'requirements', 'knossos'], 'python-analysis-v10'),
