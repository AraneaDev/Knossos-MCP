...
$materials = [];
foreach (['Dockerfile', 'composer.lock', 'package-lock.json', 'workers/php/composer.lock', 'workers/typescript/package-lock.json', 'workers/rust/Cargo.toml', 'workers/rust/Cargo.lock'] as $path) {
