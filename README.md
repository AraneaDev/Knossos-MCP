...
caches, the graph database, and a `.mcp.json` that registered a second,
broken MCP server nobody asked for. A directory containing only the plugin
copies only the plugin.
